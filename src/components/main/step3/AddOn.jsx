...
const AddOn = ({ addOnName, addOnBio, addOnPrice, checked, name }) => {
  ...
  return (
    <div
      className={`border-2 ${checked ? "border-[hsl(243,100%,62%)]" : "border-[#80808034]"}   px-6 items-center py-3.5 rounded-lg justify-between flex`}
    >
      <div className="flex gap-5 items-center">
        ...
        />
        <div>
          <h5 className="font-[600] text-[17px] text-[#002556]">{addOnName}</h5>
          <p className="text-[15px] font-[500] text-[#9699AB]">{addOnBio}</p>
        </div>
      </div>
